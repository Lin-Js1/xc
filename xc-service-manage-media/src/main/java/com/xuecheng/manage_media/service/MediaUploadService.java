...
public class MediaUploadService {
    ...
    public ResponseResult register(String fileMd5, String fileName, Long fileSize, String mimetype, String fileExt) {
        ...
        //文件不存在时做一些准备工作，检查文件所在目录是否存在么，如果不存在则创建
    ...
    private String getChunkFileFolderPath(String fileMd5) {
        return this.getFolderPath(fileMd5) + "chunk/";
    }
    ...
    public CheckChunkResult checkchunk(String fileMd5, Integer chunk, Integer chunkSize) {
        //检查分块文件是否存在
        //得到分块文件的所在目录
        String chunkFolderPath = this.getFolderPath(fileMd5);
        //块文件
     ...
     * 合并文件
     */
    public ResponseResult megechunks(String fileMd5, String fileName, Long fileSize, String mimetype, String fileExt) {
        //1.合并所有分开
        //得到分块文件的所属目录
        String chunkFileFolderPath = this.getChunkFileFolderPath(fileMd5);
        File chunkFileFolder = new File(chunkFileFolderPath);
     ...
     * 校验文件
     */
    private boolean checkFileMd5(File merfeFile, String md5) {
        //创建文件输入流
        try {
            FileInputStream inputStream = new FileInputStream(merfeFile);
            //得到文件的md5
